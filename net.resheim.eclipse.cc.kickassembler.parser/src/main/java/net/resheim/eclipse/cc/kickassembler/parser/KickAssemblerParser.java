...
public class KickAssemblerParser extends Parser {
	...
	public static final int
		BLOCK_COMMENT=1, LINE_COMMENT=2, OPCODE=3, ASTERISK=4, COLON=5, HASH=6, 
		COMMA=7, X=8, Y=9, LEFT_PAREN=10, RIGHT_PAREN=11, LEFT_BRACE=12, RIGHT_BRACE=13, 
		BANG=14, PLUS=15, MINUS=16, EOL=17, WS=18, IDENTIFIER=19, DECIMAL_LITERAL=20, 
		HEX_LITERAL=21, HEX_LONG_LITERAL=22, BINARY_LITERAL=23;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "BLOCK_COMMENT", "LINE_COMMENT", "OPCODE", "ASTERISK", "COLON", 
			"HASH", "COMMA", "X", "Y", "LEFT_PAREN", "RIGHT_PAREN", "LEFT_BRACE", 
			"RIGHT_BRACE", "BANG", "PLUS", "MINUS", "EOL", "WS", "IDENTIFIER", "DECIMAL_LITERAL", 
			"HEX_LITERAL", "HEX_LONG_LITERAL", "BINARY_LITERAL"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 671784L) != 0)) {
				{
				{
				setState(42);
				line();
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 540704L) != 0)) {
				{
				setState(56);
				labelDeclaration();
				}
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6833232L) != 0)) {
				{
				setState(60);
				operand();
				}
