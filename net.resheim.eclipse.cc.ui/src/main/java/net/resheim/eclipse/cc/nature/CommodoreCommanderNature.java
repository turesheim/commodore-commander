...
public class CommodoreCommanderNature implements IProjectNature {
	 ...
	 */
	public static final String NATURE_ID = "net.resheim.eclipse.cc.ui.nature";
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(KickAssemblerBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(KickAssemblerBuilder.BUILDER_ID);
