...
- Commodore Commander default launch arguments disable VICE render filters and
  ...
  used by the embedded view. The UI uses integer upscaling, gives small native
  frames at least a 2x readable presentation size, and keeps wide frames at
  native size instead of applying fractional downscaling.
