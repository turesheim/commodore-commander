...
uses `tools/resolve-vice-ci-resources.sh` to locate packaged VICE data when it
is available, or export upstream VICE `v3.10` data when the distro package omits
C64 ROM resources.
