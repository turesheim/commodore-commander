...
test('createViceMonitorLabelCommands converts Kick Assembler labels to VICE commands', () => {
  const debugInfo = parseKickAssemblerDebugInfo(
    `<C64debugger version="1.0">
      <Sources values="INDEX,FILE">
      ...
      <Labels values="SEGMENT,ADDRESS,NAME,FILE_IDX,LINE1,COL1,LINE2,COL2">
        Default,$1000,Start,1,45,1,45,6
        Default,$1003,.AlreadyDotted,1,46,1,46,16
        Default,$1003,AlreadyDotted,1,46,1,46,16
        Default,$1004,bad label,1,47,1,47,10
      </Labels>
      <Breakpoints values="SEGMENT,ADDRESS,ARGUMENT">
        Default,$1000,
      </Breakpoints>
  ...
  assert.equal(
    createViceMonitorLabelCommands(debugInfo),
    [
      '; Generated by Commodore Commander from Kick Assembler debug info.',
      'al C:1000 .Start',
      'al C:1003 .AlreadyDotted',
      ''
    ].join('\n')
  );
  assert.equal(
    createViceMonitorLabelCommands(debugInfo, { handoffAddress: 0x1000 }),
    [
      '; Generated by Commodore Commander from Kick Assembler debug info.',
      'al C:1000 .Start',
      'al C:1003 .AlreadyDotted',
